...
export function attachStudioBg3dEditorLtHost(h) {
  const {
    ...
    commitCustomModelPlacement, addCustomModelToScene, applyUserTemplate,
  ...
  h.handlePanelTabChange = handlePanelTabChange;
  ...
  h.reportLtUserPresetMutationFailure = reportLtUserPresetMutationFailure;
  ...
  h.persistLtUserPresetMutation = persistLtUserPresetMutation;
  ...
  h.currentLtUserPresetDraft = currentLtUserPresetDraft;
  ...
  h.saveCurrentLtAsUserPreset = saveCurrentLtAsUserPreset;
  ...
  h.updateManagedLtUserPreset = updateManagedLtUserPreset;
  ...
  h.renameManagedLtUserPreset = renameManagedLtUserPreset;
  ...
  h.deleteManagedLtUserPreset = deleteManagedLtUserPreset;
  ...
  h.updateLtLineSettings = updateLtLineSettings;
  ...
  h.updateLtToneSettings = updateLtToneSettings;
  ...
  h.updateLtExportHeight = updateLtExportHeight;
  ...
  h.updateRenderExposure = updateRenderExposure;
  ...
  h.applySunRigConfig = applySunRigConfig;
}
