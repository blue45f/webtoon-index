...
export function attachStudioBg3dEditorGenericHost(h) {
  const {
    ...
    selectedGenericModelProxies, effectiveGenericModelProxyId, selectedJointByKey,
    ...
    effectivelyVisibleLayerIds, surfaceSnapDisabledReason, measurementDisabledReason,
    focusSelectionDisabledReason, cancelMeasurement, measurementInferenceReferences,
    resolveMeasurementCandidate, updateMeasurementPreview, pickMeasurementPoint,
    handleMeasurementSurfacePreview, handleMeasurementLengthLockChange, toggleMeasurement,
    toggleSurfaceSnap, handleSurfaceSnapPick, physicsSelectionUnavailableReason,
    ...
    genericModelSourceFormats, setGenericModelClassifications, setGenericModelControlMode, setGenericModelSelectedProxyId, setPoseJointSelection,
  } = { ...R, ...h };
  ...
  h.changeSelectedGenericModelClassification = changeSelectedGenericModelClassification;
  ...
  h.changeGenericModelControlMode = changeGenericModelControlMode;
  ...
  h.selectGenericModelProxy = selectGenericModelProxy;
  ...
  h.commitSelectedPoseOverride = commitSelectedPoseOverride;
  ...
  h.commitSelectedAimConstraint = commitSelectedAimConstraint;
  ...
  h.commitSelectedTwoBoneIkConstraint = commitSelectedTwoBoneIkConstraint;
}
